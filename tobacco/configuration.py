...
USER_SPECIFIED_NODE_ASSIGNMENT = False #False: Set initially to create bb_options. True: Set to create MOF for each crhomosome
COMBINATORIAL_EDGE_ASSIGNMENT = True #True: Set initially to create bb_options. False: Set to create MOF for each crhomosome
CHARGES = False
